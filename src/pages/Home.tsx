...
export function Home() {
	...
	return (
		<>
			...
			<Modal opened={openedDeleteAllItems} onClose={closeDeleteAllItems} size="sm" title="Excluir todos os items" centered xOffset={0}>
			...
			<Modal opened={openedEditItem} onClose={closeEditItem} size="sm" title="Atualizar item" centered xOffset={0}>
				<Input
